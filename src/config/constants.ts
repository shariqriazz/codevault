...
export const INDEXING_CONSTANTS = {
  ...
  DEFAULT_CONCURRENCY: parseInt(process.env.CODEVAULT_INDEXING_CONCURRENCY || '200', 10),

  /** Safety cap for concurrent file processing */
  MAX_CONCURRENCY: parseInt(process.env.CODEVAULT_MAX_INDEXING_CONCURRENCY || '1000', 10),
} as const;
